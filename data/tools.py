...
class Control(object):
    ...
    def __init__(self, caption):
        ...
        self.render_surf = pg.Surface(self.render_size)
    ...
    def update(self, dt):
        ...
        if self.state.quit:
            ...
            self.flip_state()
        self.state.update(dt, self.scale)
        self.state.draw(self.render_surf)
        if self.screen.get_size() != self.render_size:
            self.screen.blit(pg.transform.smoothscale(self.render_surf, self.screen.get_size()), (0, 0))
        else:
    ...
    def scale(self):
        ...
        return self.render_size[0] / float(w), self.render_size[1] / float(h)
